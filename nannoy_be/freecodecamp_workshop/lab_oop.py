...
#instance of the Planet class i.e object 
planet_1 = Planet("Mercury","Terrestial","O-type")
planet_2 = Planet("Venus","Rocky","N-type")
planet_3 = Planet("Jupiter","Gas giant","P-type")
